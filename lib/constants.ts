// lib/constants.ts  ← ACTUALIZADO em Etapa 6
// Actualizações: IBAN real + validação BI angolano
...
export const BUSINESS = {
  ...
  phone: {
    main: '+244 944 328 913',
    secondary: '+244 944 328 894',
    whatsapp: '244944328913',
  },
...
// ─── VALIDAÇÃO BI ANGOLANO ────────────────────────────────────────────────────
// Formato do BI de Angola: 9 dígitos + 2 letras + 3 dígitos
// Exemplo: 000123456LA001
...
/**
 * Valida um número de BI angolano
 * Formato: 9 dígitos numéricos + 2 letras maiúsculas + 3 dígitos
 * @param bi - string do BI (aceita com ou sem espaços)
...
/**
 * Formata BI para exibição padronizada
 */
