  ...
  return (
    ...
    >
      <div aria-hidden style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
        <Image src="/stock/doctor-b.jpg" alt="" fill style={{ objectFit: 'cover', opacity: 0.50 }} />
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(115deg, rgba(50,96,34,0.80) 0%, rgba(50,96,34,0.58) 55%, rgba(50,96,34,0.30) 100%)' }} />
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, #2a5a1c 0%, transparent 28%, transparent 72%, #2a5a1c 100%)' }} />
      </div>
